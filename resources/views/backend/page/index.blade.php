...
@section('content')
    <div class="row">
        ...
        <div class="col-md-6 d-flex justify-content-end">
            <a href="{{ route('admin.page.add') }}" class="btn btn-primary waves-effect waves-light" type="button"><i
                            ...
                            @foreach ($pages as $index => $item)
                                <tr>
                                    ...
                                    <td><img width="auto" height="80px"
                                            src="{{ asset('uploads/page_images/' . $item->image) }}"
                                            alt="{{ $item->title }}"></td>
                                    <td>
                                        {{ $item->title }}
                                    </td>
                                    ...
                                    <td>
                                        <div class="d-flex g-10">
                                            <a href="{{ route('admin.page.edit', $item->id) }}" class="dropdown-item"
                                                data-id="{{ $item->id }}"><i
