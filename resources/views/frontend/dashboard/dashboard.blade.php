                                                    ...
                                                    <form action="" class="my-3">
                                                         <div class="row">
                                                              <div class="col-md-6 mb-3">
                                                                      ...
                                                                      <input type="text" placeholder="First Name" class="form-control" name="first_name" id="">
                                                              </div>
                                                              <div class="col-md-6 mb-3">
                                                                      <label for="" class="form-label">Last Name</label>
                                                                      <input type="text" placeholder="Last Name" class="form-control" name="last_name" id="">
                                                              </div>
                                                              <div class="col-md-6 mb-3">
                                                                    ...
                                                                    <label for="" class="form-label">Gender</label>
                                                                       <div class="d-flex" style="gap: 10px">
                                                                        <div class="form-check">
                                                                            <input class="form-check-input" type="radio" name="flexRadioDisabled1" id="flexRadioDisabled1">
                                                                            <label class="form-check-label" for="flexRadioDisabled1">
                                                                              Male
                                                                            </label>
                                                                          </div>
                                                                          <div class="form-check">
                                                                            <input class="form-check-input" type="radio" name="flexRadioDisabled2" id="flexRadioCheckedDisabled2" checked>
                                                                            <label class="form-check-label" for="flexRadioCheckedDisabled2">
                                                                              Female
                                                                            </label>
                                                                          </div>
                                                                          <div class="form-check">
                                                                            <input class="form-check-input" type="radio" name="flexRadioDisabled3" id="flexRadioCheckedDisabled3" >
                                                               ...
                                                               <div class="col-md-12 my-2 d-flex align-items-center justify-content-center">
                                                ...
                                                <form action="" class="my-3">
                                                    <div class="row">
                                                         ...
                                                         <div class="col-md-6 mb-3">
                                                                 ...
                                                                 <input type="text" class="form-control" name="address_line_one" placeholder="Address Line 1" id="">
                                                          </div>
                                                          <div class="col-md-6 mb-3">
                                                            <label for="" class="form-label">Address Line 2</label>
                                                            <input type="text" class="form-control" name="address_line_two" placeholder="Address Line 2" id="">
                                                          </div>
                                                          <div class="col-md-4 mb-3">
                                                            <label for="" class="form-label">Contact Number</label>
                                                            <input type="number" class="form-control" name="phone" placeholder="Contact Number" id="">
                                                          </div>
                                                          <div class="col-md-4 mb-3">
                                                            <label for="" class="form-label">Company</label>
                                                            <input type="text" class="form-control" name="company" placeholder="Company" id="">
                                                          </div>
                                                          <div class="col-md-4 mb-3">
                                                            <label for="" class="form-label">Postal/Zip Code</label>
                                                            <input type="text" class="form-control" name="postal_code" placeholder="Postal or Zip Code" id="">
                                                          </div>
                                                           <div class="col-md-6 mb-3">
                                        ...
                                        <div class="card">
                                            <div class="card-body text-center">
                                                    ...
                                                    <form action="" class="my-3">
                                                         <div class="row">
                                                              <div class="col-md-6 mb-3">
                                                                      <input type="text" placeholder="Old Password" class="form-control" name="old_passowrd" id="">
                                                              </div>
                                                              <div class="col-md-6 mb-3">
                                                                      <input type="text" placeholder="New Password" class="form-control" name="new_passowrd" id="">
                                                              </div>
                                                              <div class="col-md-12 mb-3">
                                                                      <input type="text" placeholder="Confirm Password" class="form-control" name="confirm_passowrd" id="">
                                                               </div>
                                                               <div class="col-md-12 my-2 d-flex align-items-center justify-content-center">
