                    ...
                    <div class="card-body">
                            ...
                            <ul class="nav nav-pills flex-row">
                                <li class="nav-item">
                                    <a class="nav-link mylinks active" id="stacked-pill-1" data-bs-toggle="pill"
                                        href="#horizental-pill-1" aria-expanded="true">
                                        Simple Product
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link mylinks" id="stacked-pill-2" data-bs-toggle="pill" href="#horizental-pill-2"
                                        aria-expanded="false">
                                        Variable Product
                                    </a>
                                </li>
                        ...
                        <div class="col-md-12 col-sm-12">
                            <div class="tab-content">
                                <div role="tabpanel" class="tab-pane active" id="horizental-pill-1" aria-labelledby="stacked-pill-1"
                                    aria-expanded="true">
                                    <p>Monthly</p>
                                    <form id="addserviceplan" method="POST">
                                        @csrf
                                         <div class="row">
                                            <div class="col-md-6">
                                                <label for="">Marked Price</label>
                                                <input type="text" name="mrp" id="">
                                            </div>
                                            <div class="col-md-6">
                                        ...
                                        <button type="submit" class="btn btn-success mt-1">Submit Pricing</button>

                                    </form>
                                </div>
                                <div class="tab-pane" id="horizental-pill-2" role="tabpanel" aria-labelledby="stacked-pill-2"
                                    aria-expanded="false">
                                    <p>Monthly</p>
                                    <form id="addserviceplan" method="POST">
                                        @csrf
                                        @if (count($v_productdata) > 0)
                                            @foreach ($monthlydata as $ind => $item)
                                                    ...
                                                    <div class="card-body main-card-body">
                                                        <div class="row">
                                                            <div class="col-md-4">
                                                                ...
                                                                <select name="plans[{{ $ind }}][plan_id]" class="form-select"
                                                                    id="">
                                                                    <option value="" hidden selected disabled>Select Plan</option>
                                                            ...
                                                            <div class="col-md-4">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    name="plans[{{ $ind }}][price]" value="{{ $item->price }}"
                                                                    placeholder="Rs 1200000">
                                                                <span class="invalid-feedback price_error"></span>
                                                            </div>
                                                        </div>
                                                        <div class="row mt-2">
                                                                        ...
                                                                        <div class="facility-row row">
                                                                            <div class="col-md-4">
                                                                                ...
                                                                                <input type="text" class="form-control"
                                                                                    ...
                                                                                    value="{{ $detail['title'] }}">
                                                                                <span class="invalid-feedback fac_title_error"></span>
                                                                            </div>
                                                                            <div class="col-md-7">
                                                                                <label class="form-label">Amenities</label>
                                                                                <input type="text" class="form-control"
                                                                                    name="plans[{{ $ind }}][facilities][{{ $in }}][amenities]"
                                                                                    value="{{ $detail['amenities'] }}"
                                                                                    placeholder="eg. Facebook,Instagram,Youtube etc">
                                                                                <div class="form-text">Please Type Multiple Amenities
                                                                                    using a comma (,) </div>
                                                                                <span class="invalid-feedback fac_amenity_error"></span>
                                                                            </div>
                                                                            <div class="col-md-1">
                                                                                <div class="d-flex g-10 align-items-center"
                                                                                    ...
                                                                                    @if ($in == 0)
                                                                                        <a onclick="addFacility(this)"
                                                                                            ...
                                                                                            class="pull-right dropdown-item add-facility-btn">
                                                                                            <i class="fa-solid fa-plus"></i>
                                                                                        </a>
                                                                                    @endif
                                                                                    <a onclick="removeFacility(this)"
                                                                                        class="df dropdown-item"><i
                                                                ...
                                                                @else
                                                                    <div class="facility-row row">
                                                                        <div class="col-md-4">
                                                                            <label class="form-label">Title</label>
                                                                            <input type="text" class="form-control"
                                                                                name="plans[{{ $ind }}][facilities][0][title]"
                                                                                placeholder="eg. Social Media Handling">
                                                                            <span class="invalid-feedback fac_title_error"></span>
                                                                        </div>
                                                                        <div class="col-md-7">
                                                                            <label class="form-label">Amenities</label>
                                                                            <input type="text" class="form-control"
                                                                                name="plans[{{ $ind }}][facilities][0][amenities]"
                                                                                placeholder="eg. Facebook,Instagram,Youtube etc">
                                                                            <div class="form-text">Please Type Multiple Amenities using
                                                                                a comma (,)</div>
                                                                            <span class="invalid-feedback fac_amenity_error"></span>
                                                                        </div>
                                                                        <div class="col-md-1">
                                                                            <div class="d-flex g-10 align-items-center"
                                                                                style="margin-top: 20px;">
                                                                                <a onclick="addFacility(this)" data-fac-count="0"
                                                                                    class="pull-right dropdown-item add-facility-btn"><i
                                            ...
                                            <div class="card main-card"
                                                ...
                                                <div class="card-body main-card-body">
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <label for="">Plan</label>
                                                            <select name="plans[0][plan_id]" class="form-select" id="">
                                                                <option value="" hidden selected disabled>Select Plan</option>
                                                                @foreach ($plans as $plan)
                                                        ...
                                                        <div class="col-md-4">
                                                            <label class="form-label">Price</label>
                                                            <input type="text" class="form-control" name="plans[0][price]"
                                                                placeholder="Rs 1200000">
                                                            <span class="invalid-feedback price_error"></span>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="facilities">
                                                            <div class="facility-row row">
                                                                ...
                                                                <div class="col-md-7">
                                                                    <label class="form-label">Amenities</label>
                                                                    <input type="text" class="form-control"
                                                                        name="plans[0][facilities][0][amenities]"
                                                                        placeholder="eg. Facebook,Instagram,Youtube etc">
                                                                    <div class="form-text">Please Type Mutiple Amentites using ,
                                                                        (commma)
                                                                    </div>
                                                                    <span class="invalid-feedback fac_amenity_error"></span>
                                                                </div>
                                                                <div class="col-md-1">
                                                                    <div class="d-flex g-10 align-items-center"
                                                                        ...
                                                                        <a onclick="addFacility(this)" data-fac-count="0"
                                                                            class="pull-right dropdown-item add-facility-btn"><i
                                                                                class="fa-solid fa-plus"></i></a>
                                                                        <a onclick="removeFacility(this)" class="df dropdown-item"><i
                                                                                class="fa-solid fa-xmark"></i></a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                        ...
                                        <input type="hidden" name="service_id" id="{{ $row->id }}"
                                            value="{{ $row->id }}">
                                        <input type="hidden" name="type" value="Monthly" id="">
                                        <button class="btn btn-primary mt-1" onclick="addMoreCard(event)"><i
