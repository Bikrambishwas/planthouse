...
@section('content')
        ...
        <div class="col-md-6">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">
                        <a href="{{ route('admin.page') }}">Blogs</a>
                    </li>
    ...
    <form action="{{ route('admin.blog.update', $row->id) }}" id="updateblog" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="row mt-2">
            <div class="col-md-9">
                <div class="card">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-2">
                                <div class="dashed-box">
                                    <img src="{{ asset('uploads/blog_images/' . $row->image) }}" id="editshowimage"
                                        alt="">
                                </div>
                            ...
                            <input type="hidden" name="" id="row_idblog" value="{{ $row->id }}">
                            <div class="col-md-12">
