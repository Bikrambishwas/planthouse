                ...
                <ul class="eccart-pro-items item1">
                    <li>
                        <div class="sidecart_pro_img">
                            <img src="https://admin.gamalaghar.com/storage/images/products/featured/1732765797_ASH06241.webp"
                                class="main-image">
                        </div>
                            ...
                            <dl class="quantity-wrapper">
                                <dt><label for="Quantity-1" class="visually-hidden">Quantity</label>
                                    <quantity-input class="quantity-cart">
                                        ...
                                        <input class="quantity__input-cart" type="number" name="updates[]"
                                            value="1" min="0" aria-label="Quantity for Jade Plant Mini"
                    ...
                    <table class="table cart-table">
                        <tbody>
                            <tr>
                                ...
                                <td class="text-right primary-color total-price-guest" id="total-price-guest">1750
                                </td>
                            </tr>
                        </tbody>
                    </table>
                                ...
                                <li class="nav-item active">
                                    ...
                                    @else
                                        <a class="nav-link dropdown-toggle pe-3" role="button"
                                            id="{{ $item->position }}" data-bs-toggle="dropdown"
                                            aria-expanded="false">{{ $item->title }}</a>
                                    @endif
                                    @if (!empty($item->children))
                                        <ul class="dropdown-menu border-0 p-3 rounded-0 shadow"
                                            aria-labelledby="{{ $item->position }}">
                                            @foreach ($item->children as $child)
                                                <li><a href="{{ $child->url }}"
                                                        class="dropdown-item">{{ $child->title }} </a></li>
                                            @endforeach
                                        </ul>
                                    @endif
                                </li>
